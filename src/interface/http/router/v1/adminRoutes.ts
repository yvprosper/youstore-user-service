...
router.post('/restrict/merchant', verifyAdmin, checkPermission('sanction-merchants'),api('sanctionMerchant'))
router.post('/unban/merchant', verifyAdmin, checkPermission('sanction-merchants'),api('unRestrictMerchant'))
